...
package uk.gov.hmrc.outcomeauditingproxy.config
...
class AppConfig @Inject()(config: Configuration, servicesConfig: ServicesConfig) {
  val outcomeAuditingBaseUrl: String = servicesConfig.baseUrl("outcome-auditing")
  val outcomeAuditingAuthToken = s"Basic ${createAuth("outcome-auditing.authToken")}" //TODO
