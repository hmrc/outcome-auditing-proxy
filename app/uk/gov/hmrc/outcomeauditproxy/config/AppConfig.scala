...
package uk.gov.hmrc.outcomeauditproxy.config
...
class AppConfig @Inject()(config: Configuration, servicesConfig: ServicesConfig) {
  val outcomeAuditingBaseUrl: String = servicesConfig.baseUrl("outcome-audit")
  val outcomeAuditingAuthToken = s"Basic ${createAuth("outcome-audit.authToken")}" //TODO
